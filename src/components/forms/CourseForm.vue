...
<template>
  <form class="space-y-4" @submit.prevent="handleSubmit">
    <div>
      <label class="mb-1 block text-sm font-medium text-slate-700" for="course-name">Nome *</label>
      <input
        id="course-name"
        v-model="form.name"
        type="text"
    ...
    <div>
      <label class="mb-1 block text-sm font-medium text-slate-700" for="course-description">Descrição</label>
      <textarea
    ...
    <div>
      <label class="mb-1 block text-sm font-medium text-slate-700" for="course-workload">Carga horária total (horas) *</label>
      <input
        id="course-workload"
    ...
    <div class="flex items-center gap-2">
      <input id="course-active" v-model="form.active" type="checkbox" class="h-4 w-4 rounded border-slate-300" />
      <label for="course-active" class="text-sm font-medium text-slate-700">Ativo</label>
    </div>
